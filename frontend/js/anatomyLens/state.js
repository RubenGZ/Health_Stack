...
const TRANSITIONS = {
  [STATES.UNINITIALIZED]:        [STATES.LOADING, STATES.SVG_FALLBACK],
  [STATES.LOADING]:              [STATES.READY, STATES.SVG_FALLBACK],
  [STATES.READY]:                [STATES.TRANSITIONING_CAMERA, STATES.SVG_FALLBACK],
  [STATES.TRANSITIONING_CAMERA]: [STATES.HIGHLIGHTING, STATES.TRANSITIONING_CAMERA, STATES.READY, STATES.SVG_FALLBACK],
