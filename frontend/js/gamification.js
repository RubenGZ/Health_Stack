...
const Gamification = (function () {
  ...
  const LEVELS = [
    ...
    { level: 4, nameKey: 'gamification.level_atleta',     min: 3000,  color: '#c4a561', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>' },
    ...
    { level: 7, nameKey: 'gamification.level_maestro',    min: 15000, color: '#d4b97a', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>' },
