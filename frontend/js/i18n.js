...
;(function () {
  ...
  const LOCALES = {
    ...
    /* ── ENGLISH ──────────────────────────────────────────────── */
    en: {
      nav: { dashboard:'Dashboard', nutrition:'Nutrition', weight:'Weight', exercises:'Exercises', routines:'Routines', planner:'Planner', supplements:'Supplements', timing:'Optimal Schedule', achievements:'Achievements', community:'Community', group_train:'Train', workout:'Workouts', rehab:'Rehab', fatigue:'Accumulated Fatigue', records:'1RM Records', deload:'Auto-Deload' },
