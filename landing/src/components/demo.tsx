...
const FEATURE_META = [
  { icon: <Zap   className="w-6 h-6" style={{ color: '#ff6a00' }} />, iconCls: 'bg-orange-500/10 border border-orange-500/20', cardHover: 'hover:border-orange-500/25 hover:bg-orange-500/[0.04]' },
...
const TESTIMONIAL_META = [
  { avatar: 'C', avatarCls: 'from-orange-500 to-amber-400 text-black'   },
...
function DashboardMockup() {
  ...
  const stats = [
    ...
    { labelKey: 'dashboard.calories', value: '2,340 kcal', change: '+120',                  color: 'text-orange-400', border: 'border-orange-500/20' },
  ...
  const macros = [
    ...
    { labelKey: 'dashboard.carbs',   g: '210g', pct: 55, color: '#ff6a00' },
    ...
    <div className="bg-[#0a0a14] select-none">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06]">
        <span className="text-white font-black uppercase tracking-widest text-sm" style={HEADING}>
          HEALTHSTACK <span className="text-orange-400">PRO</span>
        </span>
        <div className="flex items-center gap-3">
          <span className="text-[10px] font-bold uppercase tracking-widest text-orange-400 bg-orange-500/10 border border-orange-500/20 px-2.5 py-1 rounded-full">
            🔥 {t('dashboard.streak')} 12d
          </span>
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-amber-400 flex items-center justify-center text-black text-xs font-black">R</div>
        </div>
      </div>
      ...
      <div className="p-6 grid grid-cols-12 gap-4">
                ...
                <div key={i} className="flex-1 flex flex-col items-center gap-1 justify-end">
                  <div className="w-full rounded-sm" style={{
                    ...
                    background: i === bars.length - 1
                      ? 'linear-gradient(to top, #ff6a00, #f59e0b)'
                      : 'rgba(255,106,0,0.22)',
                  }} />
        ...
        <div className="col-span-6 bg-white/[0.035] border border-white/[0.06] rounded-xl p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-[8px] text-orange-400 font-bold">PUSH A</span>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#050508] text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-4
        ...
        <span className="text-xl font-black uppercase tracking-widest bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-amber-400" style={HEADING}>
          HEALTHSTACK PRO
        </span>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button className="px-5 py-2.5 text-[11px] font-extrabold uppercase tracking-widest rounded-xl bg-gradient-to-r from-orange-500 to-amber-400 text-black border-0 shadow-[0_4px_20px_rgba(255,106,0,0.35)] hover:shadow-[0_6px_28px_rgba(255,106,0,0.5)] hover:-translate-y-0.5 transition-all">
            {t('nav.cta')}
          </Button>
      ...
      <Card className="w-full min-h-screen bg-black/[0.96] relative overflow-hidden rounded-none border-0 pt-20">
        ...
        <div className="flex h-full min-h-[calc(100vh-80px)]">
          ...
          <div className="flex-1 p-8 md:p-14 lg:p-20 relative z-10 flex flex-col justify-center max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 text-[11px] font-bold uppercase tracking-[2px] mb-8 w-fit">
            ...
            <h1 className="text-[clamp(3rem,8vw,5.8rem)] font-black leading-[0.92] tracking-widest mb-6 uppercase" style={HEADING}>
              ...
              <TypewriterEffect
                ...
                className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 via-amber-400 to-orange-600"
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              <Button className="px-8 py-6 text-[0.82rem] font-extrabold uppercase tracking-widest rounded-xl bg-gradient-to-r from-orange-500 to-amber-400 text-black shadow-[0_8px_32px_rgba(255,106,0,0.38)] hover:shadow-[0_14px_44px_rgba(255,106,0,0.55)] transition-all duration-200 hover:-translate-y-0.5 border-0">
              ...
              {STAT_VALUES.map((stat, i) => (
                <div key={i} className={`flex flex-col gap-0.5 px-5 ${i > 0 ? 'border-l border-white/[0.07]' : 'pl-0'}`}>
                  <span className="text-[2rem] font-black tracking-wide text-white leading-none" style={HEADING}>
                    {stat.v}<span className="text-orange-400">{stat.s}</span>
                  </span>
          ...
          <div className="flex-1 relative hidden md:block min-h-[500px]">
            <div aria-hidden className="absolute inset-0 pointer-events-none z-0" style={{
              background: 'radial-gradient(ellipse 58% 68% at 60% 52%, rgba(255,106,0,0.12) 0%, transparent 65%)',
            }} />
      ...
      {/* ── SOCIAL PROOF BAND ───────────────────────────────── */}
      <div className="py-10 px-8 md:px-16 bg-orange-500/[0.04] border-y border-orange-500/[0.1] flex items-center justify-center gap-8 md:gap-16 flex-wrap">
        {BAND_VALUES.map((v, i) => (
          <div key={i} className="flex flex-col items-center gap-1">
            <span className="text-3xl md:text-4xl font-black bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-amber-400 leading-none" style={HEADING}>{v}</span>
      ...
      <section className="py-24 px-8 md:px-16 bg-[#080810]">
        <div className="mb-16">
          <p className="text-[11px] font-bold uppercase tracking-[3px] text-orange-400 mb-3">{t('features.label')}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map(f => (
            <Card key={f.title} className={`group bg-white/[0.025] border-white/[0.065] rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1.5 cursor-default relative overflow-hidden ${f.cardHover}`}>
              <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-orange-500 to-sky-400 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
      ...
      <ContainerScroll
        ...
        titleComponent={
          <>
            <p className="text-[11px] font-bold uppercase tracking-[3px] text-orange-400 mb-4">{t('preview.label')}</p>
            <h2 className="text-5xl md:text-6xl font-black uppercase tracking-widest leading-[0.94] text-white mb-4" style={HEADING}>
      ...
      <section className="relative overflow-hidden h-[380px] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6">
          <p className="text-[11px] font-bold uppercase tracking-[3px] text-orange-400 mb-4">{t('shader.label')}</p>
          <h2 className="text-5xl md:text-7xl font-black uppercase tracking-widest leading-[0.92] text-white mb-5" style={HEADING}>
            {t('shader.title_1')}<br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 via-amber-400 to-orange-500" style={{ filter: 'drop-shadow(0 0 20px rgba(255,106,0,0.5))' }}>
              {t('shader.title_2')}
            </span>
          </h2>
      ...
      <section className="py-24 px-8 md:px-16 bg-[#050508]">
        <div className="mb-16">
          <p className="text-[11px] font-bold uppercase tracking-[3px] text-orange-400 mb-3">{t('testimonials.label')}</p>
          <h2 className="text-5xl md:text-6xl font-black uppercase tracking-widest leading-[0.94] text-white mb-4" style={HEADING}>
      ...
      <section className="py-24 px-8 md:px-16 bg-[#080810] border-t border-white/[0.035]">
        <div className="mb-16 text-center">
          <p className="text-[11px] font-bold uppercase tracking-[3px] text-orange-400 mb-3">{t('pricing.label')}</p>
          <h2 className="text-5xl md:text-6xl font-black uppercase tracking-widest leading-[0.94] text-white mb-4" style={HEADING}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-5xl mx-auto">
          {plans.map(plan => (
            <Card key={plan.tier} className={`rounded-2xl p-9 flex flex-col relative transition-all duration-300 hover:-translate-y-1 ${plan.featured ? 'bg-orange-500/[0.05] border-orange-500/40 shadow-[0_0_60px_rgba(255,106,0,0.12)]' : 'bg-white/[0.025] border-white/[0.065]'}`}>
              {plan.featured && (
                <div className="absolute -top-px left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-orange-500 to-amber-400 text-black text-[10px] font-extrabold uppercase tracking-widest rounded-b-lg whitespace-nowrap">
                  {t('pricing.popular')}
                </div>
              )}
              <p className={`text-[10px] font-bold uppercase tracking-[2.5px] mb-4 ${plan.featured ? 'text-orange-400' : 'text-neutral-500'}`}>{plan.tier}</p>
      ...
      <section className="relative py-32 px-8 md:px-16 text-center overflow-hidden border-t border-white/[0.04]">
        ...
        <div className="relative z-10">
          <p className="text-[11px] font-bold uppercase tracking-[3px] text-orange-400 mb-5">{t('cta.label')}</p>
          <h2 className="text-5xl md:text-7xl font-black uppercase tracking-widest leading-[0.92] text-white mb-4" style={HEADING}>
            {t('cta.title_1')}<br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-amber-400" style={{ filter: 'drop-shadow(0 0 24px rgba(255,106,0,0.4))' }}>
              {t('cta.title_2')}
            </span>
          </h2>
          <p className="text-neutral-400 max-w-md mx-auto mb-10 text-sm leading-relaxed">{t('cta.subtitle')}</p>
          <div className="flex gap-4 justify-center flex-wrap">
            <Button className="px-10 py-6 text-[0.82rem] font-extrabold uppercase tracking-widest rounded-xl bg-gradient-to-r from-orange-500 to-amber-400 text-black shadow-[0_8px_32px_rgba(255,106,0,0.4)] hover:shadow-[0_14px_44px_rgba(255,106,0,0.55)] hover:-translate-y-0.5 transition-all duration-200 border-0">
              <Zap className="w-4 h-4 mr-2" />
              {t('cta.primary')}
            </Button>
      ...
      <footer className="py-8 px-8 md:px-16 bg-[#080810] border-t border-white/[0.05]">
        <div className="flex items-center justify-between flex-wrap gap-4 mb-6 pb-6 border-b border-white/[0.04]">
          ...
          <nav className="flex gap-6 flex-wrap">
            {footerLinks.map(l => (
              <a key={l} href="#" className="text-xs text-neutral-500 hover:text-orange-400 transition-colors">{l}</a>
            ))}
          </nav>
        </div>
