...
window.HS_CONFIG = (function () {
  ...
  const AFFILIATE_LINKS = {
    ...
    AFFILIATE_CITRULLINE:   'https://www.amazon.es/s?k=citrulina+malato+2+1&tag=healthstackpro-21',
    AFFILIATE_THEANINE:     'https://www.amazon.es/s?k=l+teanina+200mg&tag=healthstackpro-21',
    AFFILIATE_ASHWAGANDHA:  'https://www.amazon.es/s?k=ashwagandha+KSM-66+600mg&tag=healthstackpro-21',
    AFFILIATE_COLLAGEN:     'https://www.amazon.es/s?k=colageno+hidrolizado+vitamina+c&tag=healthstackpro-21',
    AFFILIATE_LCARNITINE:   'https://www.amazon.es/s?k=l+carnitina+tartrato&tag=healthstackpro-21',
    AFFILIATE_EAA:          'https://www.amazon.es/s?k=aminoacidos+esenciales+EAA&tag=healthstackpro-21',
    AFFILIATE_ELECTROLYTES: 'https://www.amazon.es/s?k=electrolitos+deporte+sodio+potasio&tag=healthstackpro-21',
    AFFILIATE_HMB:          'https://www.amazon.es/s?k=HMB+beta+hidroxi+metilbutirato&tag=healthstackpro-21',
  };
  ...
  const SUPPLEMENTS = [
    ...
    },
    {
      ...
      icon_emoji: '🫀',
      evidence_level: 'high',
      affiliate_link_placeholder: 'AFFILIATE_CITRULLINE',
      description: 'Precursor de arginina intramuscular. Aumenta el óxido nítrico → mejor bombeo, mayor flujo sanguíneo al músculo y reducción del amonio. Estudios muestran +19% en series hasta el fallo vs. placebo. Reduce la fatiga muscular en un 40% en ejercicios de alta repetición. Superior a la arginina directa en biodisponibilidad oral.',
    },
    {
      id: 10, sort_order: 10,
      name: 'L-Teanina',
      dose: '100-200 mg',
      timing: 'Con cafeína (ratio 1:1 o 1:2)',
      level: 'optional',
      icon_emoji: '🍵',
      evidence_level: 'medium',
      affiliate_link_placeholder: 'AFFILIATE_THEANINE',
      description: 'Aminoácido del té verde que sinergia perfectamente con la cafeína. Elimina el nerviosismo y ansiedad de la cafeína manteniendo toda su energía y foco. La combinación mejora la atención sostenida un 20% más que la cafeína sola. Ideal si eres sensible a la cafeína o quieres foco puro sin jitters.',
    },
    {
      id: 11, sort_order: 11,
      ...
      icon_emoji: '🌿',
      evidence_level: 'medium',
      affiliate_link_placeholder: 'AFFILIATE_ASHWAGANDHA',
      description: 'Adaptógeno más estudiado en deportistas. Reduce el cortisol sérico un 27%, mejora la testosterona en hombres (+17% en 8 semanas), aumenta la fuerza y la recuperación. Meta-análisis 2023 confirma mejoras en VO2max. El extracto KSM-66 es el más biodisponible. Tomar el ciclo de 8-12 semanas con descanso de 4.',
    },
    {
      id: 12, sort_order: 12,
      name: 'Colágeno Hidrolizado + Vit C',
      dose: '10-15 g colágeno + 50 mg Vit C',
      timing: '1h antes del entrenamiento',
      level: 'optional',
      icon_emoji: '🦴',
      evidence_level: 'medium',
      affiliate_link_placeholder: 'AFFILIATE_COLLAGEN',
      description: 'El colágeno hidrolizado estimula la síntesis de colágeno en tendones, ligamentos y cartílagos. La vitamina C es cofactor esencial para esta síntesis — sin ella, el colágeno no se fabrica. Tomarlo 1h antes del entreno maximiza la disponibilidad durante el ejercicio. Especialmente útil para prevenir y rehabilitar lesiones de tendón.',
    },
    {
      id: 13, sort_order: 13,
      name: 'L-Carnitina Tartrato',
      dose: '2-3 g',
      timing: 'Con una comida con carbohidratos',
      level: 'optional',
      icon_emoji: '🔥',
      evidence_level: 'medium',
      affiliate_link_placeholder: 'AFFILIATE_LCARNITINE',
      description: 'Transportador de ácidos grasos a la mitocondria. Reduce el daño muscular (DOMS) y acelera la recuperación post-entreno. Requiere insulina para entrar al músculo — tomar siempre con carbohidratos. La forma tartrato tiene la mejor biodisponibilidad oral. Resultados visibles en recuperación a partir de 4-8 semanas de uso continuo.',
    },
    {
      id: 14, sort_order: 14,
      name: 'EAA (Aminoácidos Esenciales)',
      dose: '10-15 g',
      timing: 'Durante o alrededor del entreno',
      level: 'optional',
      icon_emoji: '🧬',
      evidence_level: 'medium',
      affiliate_link_placeholder: 'AFFILIATE_EAA',
      description: 'Los 9 aminoácidos esenciales que el cuerpo no puede sintetizar. Estimulan la síntesis proteica muscular (MPS) de forma directa. Superiores a los BCAAs porque incluyen todos los precursores necesarios. Imprescindibles en entrenos en ayunas o si el total de proteína diaria es bajo. La leucina (incluida) activa el sensor mTORC1.',
    },
    {
      id: 15, sort_order: 15,
      name: 'Electrolitos (Sodio + Potasio)',
      dose: '500-1000 mg sodio / hora de ejercicio',
      timing: 'Durante el entrenamiento (>45 min)',
      level: 'optional',
      icon_emoji: '⚗️',
      evidence_level: 'high',
      affiliate_link_placeholder: 'AFFILIATE_ELECTROLYTES',
      description: 'El déficit de electrolitos es la causa principal de calambres, fatiga prematura y reducción del rendimiento en sesiones largas. El sudor contiene 500-1500 mg de sodio/litro. Reponer sodio + potasio mejora la retención de fluidos y mantiene la función nerviosa y muscular. Crítico en entrenos de más de 60 min o con mucha sudoración.',
    },
    {
      id: 16, sort_order: 16,
      name: 'HMB (β-Metilbutirato)',
      dose: '3 g',
      timing: 'Distribuido en 3 tomas con comidas',
      level: 'optional',
      icon_emoji: '🛡️',
      evidence_level: 'medium',
      affiliate_link_placeholder: 'AFFILIATE_HMB',
      description: 'Metabolito de la leucina con potente efecto anticatabólico. Reduce la degradación proteica muscular en períodos de déficit calórico, entrenamiento de alta frecuencia o atletas que regresan tras lesión. Especialmente eficaz en principiantes y masters (>40 años). Forma HMB-FA (ácido libre) tiene absorción 3x más rápida que la sal de calcio.',
    },
  ];
