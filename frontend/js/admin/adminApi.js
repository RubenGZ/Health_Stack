...
var AdminAPI = (function() {
  ...
  var BASE      = IS_PROD
    ? ('https://' + location.hostname + '/api/v1/admin')
  ...
  return {
    ...
    getTimeseriesMulti: function(days)   { return req('/stats/timeseries-multi?days=' + (days || 30)); },
    getModules:         function()       { return req('/stats/modules'); },
    getPlans:           function()       { return req('/stats/plans'); },
    // DB Explorer
    ...
    // DB Health semaphore
    getDbHealth:        function()       { return req('/db/health'); },
    // System health
    getSystemHealth:    function()       { return req('/system/health'); },
    // Technical metrics
