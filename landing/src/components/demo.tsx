...
// ?action=register / ?action=login → app.js abre el modal correcto automáticamente.
const APP_REGISTER = typeof window !== 'undefined' ? window.location.origin + '/?action=register' : '/?action=register'
const APP_LOGIN    = typeof window !== 'undefined' ? window.location.origin + '/?action=login'    : '/?action=login'
const GOOGLE_URL   = typeof window !== 'undefined' ? window.location.origin + '/api/v1/auth/google/redirect' : '/api/v1/auth/google/redirect'
const goToRegister = () => { window.location.href = APP_REGISTER }
const goToLogin    = () => { window.location.href = APP_LOGIN }
            ...
            >
              ...
              <div className="flex flex-col gap-3 mt-6">
                <Button
                  ...
                  className="w-full py-3 text-sm font-bold uppercase tracking-widest rounded-xl border-white/[0.14] text-white hover:bg-white/[0.06] flex items-center justify-center gap-2"
                >
                ...
                <Button
                  onClick={() => { goToRegister(); setMenuOpen(false) }}
          ...
          <div className="flex-1 p-8 md:p-14 lg:p-20 relative z-10 flex flex-col justify-center max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 mb-10">
              ...
              <Button
                variant="outline"
                onClick={goToGoogle}
                className="w-full sm:w-auto px-8 py-6 text-[0.82rem] font-bold uppercase tracking-wider rounded-xl border-white/[0.14] text-white hover:bg-white/[0.06] hover:border-white/30 transition-all duration-200 hover:-translate-y-0.5 flex items-center justify-center gap-2"
              >
      ...
      <section className="relative py-32 px-8 md:px-16 text-center overflow-hidden border-t border-white/[0.04]">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap">
            <Button onClick={goToRegister} className="w-full sm:w-auto px-10 py-6 text-[0.82rem] font-extrabold uppercase tracking-widest rounded-xl bg-gradient-to-r from-teal-500 to-cyan-400 text-white shadow-[0_8px_32px_rgba(8,145,178,0.4)] hover:shadow-[0_14px_44px_rgba(8,145,178,0.55)] hover:-translate-y-0.5 transition-all duration-200 border-0">
              <Zap className="w-4 h-4 mr-2" />
              {t('cta.primary')}
            </Button>
            <Button onClick={goToLogin} variant="outline" className="w-full sm:w-auto px-10 py-6 text-[0.82rem] font-bold uppercase tracking-wider rounded-xl border-white/[0.14] text-white hover:bg-white/[0.06] hover:border-white/30 hover:-translate-y-0.5 transition-all duration-200">
